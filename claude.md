...
- How modules are organized: Self-contained within `/app/modules/<module-name>/`.
...
# Summary for Agent
- **Where to integrate:** Modules go in `/app/modules/`, UI hooks into `/app/routes/`, and API routes merge into `/app/api/routes.ts`.
